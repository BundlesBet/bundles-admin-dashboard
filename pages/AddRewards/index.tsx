      ...
      <div className={classes.resultContainer}>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr className={classes.leaderboardTableBodyRow}>
              ...
              <td className={classes.leaderboardTableRowData}>0x123456789abcdefghi</td>

              <td className={classes.leaderboardTableRowData}>50%</td>
